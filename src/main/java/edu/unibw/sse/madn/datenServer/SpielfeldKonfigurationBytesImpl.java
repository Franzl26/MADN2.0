...
public class SpielfeldKonfigurationBytesImpl implements SpielfeldKonfigurationBytes {
    @Override
    public void konfigurationSpeichern(String verzeichnis) {
        saveConfiguration(verzeichnis);
    }
    ...
    private SpielfeldKonfigurationBytesImpl(Builder builder) {
    ...
    public static SpielfeldKonfigurationBytes loadBoardKonfiguration(String dir) {
    ...
    private static class Builder {
        ...
        private SpielfeldKonfigurationBytes build() {
            return new SpielfeldKonfigurationBytesImpl(this);
        }
